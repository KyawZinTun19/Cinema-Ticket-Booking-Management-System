    ...
    <div>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><form:input type="email" name="email" path="accountEmail"></form:input>
                 </td>
            </tr>
            <tr>
                <td><label>Password</label> </td>
                <td><form:input type="password" name="password" path="accountPassword"></form:input> 
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><a href="/CinemaTicketBooking/adminTable" class="CancelButton" >Cancel</a></td>
